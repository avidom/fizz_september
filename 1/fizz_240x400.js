...
p.nominalBounds = new cjs.Rectangle(-108,-24,216,48);
...
(lib.branches2 = function(mode,startPosition,loop) {
	...
	this.br3.setTransform(210.8,-88.1,0.63,0.63,0,-13.4,166.6,-128.3,43.8);

	this.br2 = new lib.Symbol5();
	this.br2.setTransform(-194.1,118.9,0.6,0.6,6.9,0,0,-128.3,43.8);

	this.br4 = new lib.Symbol6();
	this.br4.setTransform(173.2,69.4,1,1,0,0,180,-61.9,-17.6);

	this.br1 = new lib.Symbol5();
	this.br1.setTransform(-216.1,-142.2,0.869,0.869,43.4,0,0,-128.3,43.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.br1},{t:this.br4},{t:this.br2},{t:this.br3}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-201.9,-184.6,394.5,325.8);
...
(lib.branches = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.br3 = new lib.Symbol5();
	this.br3.setTransform(234.9,69.9,0.999,0.999,0,-24.5,155.5,-128.4,43.8);

	this.br2 = new lib.Symbol6();
	this.br2.setTransform(-146.9,79.4,1,1,0,0,0,-61.9,-17.6);

	this.br1 = new lib.Symbol5();
	this.br1.setTransform(-183.9,-141.9,1,1,0,0,0,-128.3,43.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.br1},{t:this.br2},{t:this.br3}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-151.6,-239.7,361.3,411.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		tl.fromTo(r.blk, 0.7, {alpha:1}, {alpha:0, ease:Power0.easeNone})
		  ...
		  .from(r.br.br1, 3.2, {rotation:"-=30", ease:Elastic.easeOut}, 0.50)
		  ...
		  .to(r.bot1, 1.0, {x:68, y:8, scaleX:0.58, scaleY:0.58, ease:Expo.easeInOut}, time4+0.50)
		  
		  
		  //5
		  .to(r.t2.slogan, 1.7, {y:"-=30", ease:Expo.easeInOut}, time5+0.00)
	...
	this.warn.setTransform(0,178,1,1.13);

	this.timeline.addTween(cjs.Tween.get(this.warn).wait(1));

	// t1
	this.t1 = new lib.t1();
	this.t1.setTransform(-2,-42.3);
	...
	this.bot1.setTransform(81,28,0.67,0.67);
...
p.nominalBounds = new cjs.Rectangle(-201.9,-239.7,411.6,460.8);
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.btnMain.setTransform(120,200,1.333,1.333);
